...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
  ...
  sendDTMF(tones) {
    ...
    const sender = this.mediaProperties.peerConnection.getSenders()[0];
    const {dtmf} = sender;

    console.log('CorrelationId', this.correlationId);
    console.log(this.locusInfo);
    console.log(this.locusId);
    console.log('is DTMF enabled?', dtmf.canInsertDTMF);

    if (dtmf.canInsertDTMF) {
      dtmf.insertDTMF('1', 4000);
      sender.ontonechange = async (e) => console.log('tone finished', e);

      console.log('dtmf sent, apparently');
    }
    ...
    return Promise.resolve('dtmf process handled');
  }
